 ...
 *
 * @code <plugin type="plugins.SqlUpdateKeyAddLastUpdatedPlugin">
...
public class SqlUpdateKeyAddLastUpdatedPlugin extends PluginAdapter {
     ...
     * プロパティ名
     */
    private static final String PROPERTY_VERSION_COLUMNS = "lastUpdatedColumns";
    ...
    private String getNewIdName(String originalName) {
        return originalName.replaceAll("ByPrimaryKey", "ByPrimaryKeyAndLastUpdated");
    }
